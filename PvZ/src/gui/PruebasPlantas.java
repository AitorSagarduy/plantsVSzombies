...
public class PruebasPlantas extends JFrame {
	/**
	 * 
	 */
	...
	public static void main(String[] args) {
        ...
        PruebasPlantas ventana = new PruebasPlantas();
	}
	JPanel panelGeneral;
	JPanel panelBotones;
	JPanel panelPlantas;
	...
	public PruebasPlantas() {
        ...
        agregar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(filaSeleccionada  == -1) {
					JOptionPane.showMessageDialog(PruebasPlantas.this, "Selecciona una planta", "Error", JOptionPane.ERROR_MESSAGE);
					return;
				}
        ...
        eliminar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(filaSeleccionada  == -1) {
					JOptionPane.showMessageDialog(PruebasPlantas.this, "Selecciona una planta de la tabla de abajo", "Error", JOptionPane.ERROR_MESSAGE);
					return;
				}
				//restar la cantidad
